...
<div id="llm-config-container" class="mx-auto max-w-7xl mt-4 sm:px-6 lg:px-8 border rounded-lg">
    <div class="space-y-6 sm:space-y-5 pt-2 sm:pt-4">
        <div class="col-span-full">
            ...
            <p class="mt-1 text-sm leading-6 text-gray-600">Please provide the base URL for your LLM API endpoint and its associated API key. The endpoint must be compatible with OpenAI's <a href="https://platform.openai.com/docs/api-reference/chat" class="underline text-green-700">Chat API structure</a>. By default, the URL below points to the API on OpenAI's platform.</p>
